                                        ...
                                        <table style="width: 100%; margin-bottom: 20px;">
                                            <tbody>
                                               <tr>
                                                <td style="text-align: center;" colspan="2">
                                                    <h4 style="font-size: 23px; line-height: 30px; margin:2px; padding: 0;">Yameen Food Centre</h4>
                                                    <p style="font-size: 16px; line-height: 24px; margin:2px; padding: 0;">1/1510 Shah Faisal Colony Block 01, Karachi, Pakistan</p>
                                                    <p style="font-size: 16px; line-height: 24px; margin:2px; padding: 0;">SEO Bolingbrook pvt ltd.</p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="end">
                                                    ...
                                                    <p style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;">Address: 1st main road, Karachi, Pakistan</p>
                                                </td>
                                            </tr>
